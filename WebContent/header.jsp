		...
		<c:if test="${ empty user }">		
		   <li><a href="login.jsp">登录</a></li>
			...
			<c:if test="${! empty user }">
				...
				<li><a href="${pageContext.request.contextPath }/user?method=quickUser">退出</a></li>
			</c:if>
			...
			$.post(			
					...
					function (data){						
						for(var i=0;i<data.length;i++){						
							context=context+"<li><a href='${pageContext.request.contextPath}/product?method=productListByCid&cid="+data[i].cid+"'>"+data[i].cname+"</a></li>";
						}					
